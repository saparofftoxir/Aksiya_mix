                    ...
                    <div className='w-full h-full flex flex-col gap-y-1'>
                        ...
                        <div className='flex flex-col gap-y-3'>
                            ...
                            onChange={e=>setTel(e.target.value)}
                                id="phoneInput"
                                className='w-full h-48 text-14 rounded-lg bg-reg_bg text-text_b outline-none px-3'
                                type="tel"
                                value={tel}
                            />

                            <button onClick={showSecondModal}  className='w-full h-48 text-16 font-medium rounded-lg text-text_b outline-none px-3 bg-reg_blue text-white' type="text" placeholder='+998'>
                                Получить код
                            </button>
